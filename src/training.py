...
def simulate(current, peak_percentage, peak_period, target_profit, drop_time):
    ...
    while current < exit_datetime:
        ...
        if selling_price:
            ...
            elif (current_time - selling_list_time) > timedelta(hours=drop_time):
                base_currency_amount = target_currency_amount * current_price
                target_currency_amount = 0
                selling_price = None
                selling_list_time = None
...
#simulate(datetime(2020, 6, 2), 1.04, 12, 1.02, 24)
simulate(datetime(2021, 1, 1), 1.04, 12, 1.02, 24)
